    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["cortex channels list", "List configured channels and auth profiles."],
          ["cortex channels status --probe", "Run channel status checks and probes."],
          [
            "cortex channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["cortex channels login --channel whatsapp", "Link a WhatsApp Web account."],
