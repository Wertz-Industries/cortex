...
const SANDBOX_EXAMPLES = {
  main: [
    ["cortex sandbox list", "List all sandbox containers."],
    ["cortex sandbox list --browser", "List only browser containers."],
    ["cortex sandbox recreate --all", "Recreate all containers."],
    ["cortex sandbox recreate --session main", "Recreate a specific session."],
    ["cortex sandbox recreate --agent mybot", "Recreate agent containers."],
    ["cortex sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["cortex sandbox list", "List all sandbox containers."],
    ["cortex sandbox list --browser", "List only browser containers."],
    ["cortex sandbox list --json", "JSON output."],
  ],
  recreate: [
    ["cortex sandbox recreate --all", "Recreate all containers."],
    ["cortex sandbox recreate --session main", "Recreate a specific session."],
    ["cortex sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["cortex sandbox recreate --browser --all", "Recreate only browser containers."],
    ["cortex sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["cortex sandbox explain", "Show effective sandbox config."],
    ["cortex sandbox explain --session agent:main:main", "Explain a specific session."],
    ["cortex sandbox explain --agent work", "Explain an agent sandbox."],
    ["cortex sandbox explain --json", "JSON output."],
  ],
} as const;
