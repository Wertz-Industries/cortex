    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["cortex memory status", "Show index and provider status."],
          ["cortex memory index --force", "Force a full reindex."],
          ['cortex memory search --query "deployment notes"', "Search indexed memory entries."],
          ["cortex memory status --json", "Output machine-readable JSON."],
