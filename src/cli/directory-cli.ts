    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["cortex directory self --channel slack", "Show the connected account identity."],
          [
            'cortex directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["cortex directory groups list --channel discord", "List available groups/channels."],
          [
            "cortex directory groups members --channel discord --group-id <id>",
