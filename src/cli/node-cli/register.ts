    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["cortex node run --host 127.0.0.1 --port 18789", "Run the node host in the foreground."],
          ["cortex node status", "Check node host service status."],
          ["cortex node install", "Install the node host service."],
          ["cortex node restart", "Restart the installed node host service."],
