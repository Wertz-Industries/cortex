      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["cortex gateway run", "Run the gateway in the foreground."],
            ["cortex gateway status", "Show service status and probe reachability."],
            ["cortex gateway discover", "Find local and wide-area gateway beacons."],
            ["cortex gateway call health", "Call a gateway RPC method directly."],
