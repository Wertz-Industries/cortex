    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["cortex nodes status", "List known nodes with live status."],
          ["cortex nodes pairing pending", "Show pending node pairing requests."],
          ['cortex nodes run --node <id> --raw "uname -a"', "Run a shell command on a node."],
          ["cortex nodes camera snap --node <id>", "Capture a photo from a node camera."],
