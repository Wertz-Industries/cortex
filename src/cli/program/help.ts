...
const EXAMPLES = [
  ["cortex models --help", "Show detailed help for the models command."],
  ["cortex channels login --verbose", "Link personal WhatsApp Web and show QR + connection logs."],
  [
    'cortex message send --target +15555550123 --message "Hi" --json',
    "Send via your web session and print JSON result.",
  ],
  ["cortex gateway --port 18789", "Run the WebSocket Gateway locally."],
  ["cortex --dev gateway", "Run a dev Gateway (isolated state/config) on ws://127.0.0.1:19001."],
  ["cortex gateway --force", "Kill anything bound to the default gateway port, then start it."],
  ["cortex gateway ...", "Gateway control via WebSocket."],
  [
    'cortex agent --to +15555550123 --message "Run summary" --deliver',
    "Talk directly to the agent using the Gateway; optionally send the WhatsApp reply.",
  ],
  [
    'cortex message send --channel telegram --target @mychat --message "Hi"',
