...
${formatHelpExamples([
  ['cortex agent --to +15555550123 --message "status update"', "Start a new session."],
  ['cortex agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
    'cortex agent --session-id 1234 --message "Summarize inbox" --thinking medium',
    "Target a session with explicit thinking level.",
  ],
  [
    'cortex agent --to +15555550123 --message "Trace logs" --verbose on --json',
    "Enable verbose logging and JSON output.",
  ],
  ['cortex agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
    'cortex agent --agent ops --message "Generate report" --deliver --reply-channel slack --reply-to "#reports"',
...
${theme.heading("Examples:")}
${formatHelpExamples([
  ['cortex agents set-identity --agent main --name "Cortex" --emoji "🦞"', "Set name + emoji."],
  ["cortex agents set-identity --agent main --avatar avatars/openclaw.png", "Set avatar path."],
  [
    "cortex agents set-identity --workspace ~/.openclaw/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "cortex agents set-identity --identity-file ~/.openclaw/workspace/IDENTITY.md --agent main",
